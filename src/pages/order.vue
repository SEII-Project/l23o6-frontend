...
<template>
  <el-container>
    ...
    <el-header style="position: fixed; width: 100%; z-index: 999">
      <MenuComponentTop pageIndex="/order" />
      <MenuComponentSecond pageIndex="/order" />
    </el-header>
      ...
      <div style="display: flex; justify-content: center">
        <el-card shadow="hover" style="width: 100vh; height: auto; border: 3px solid #AAAAAA">
          ...
          <div style="display: flex; justify-content: center; margin-top: 5vh">
            <OrderDetail :id="typeof $route.params['orderId'] === 'string' ? parseInt($route.params['orderId']) : undefined" style="width: 50%" />
          </div>
        </el-card>
      </div>
    </el-main>
